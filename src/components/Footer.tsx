...
export default function Footer() {
  return (
    <div className="flex flex-col justify-center items-center bg-bgWhite dark:bg-black text-#656C77 dark:text-#C1C1C1 text-[16px] sm:text-[20px] sm:px-8">
      <div
        className="flex flex-col sm:flex-row items-center justify-center sm:justify-between border-y border-lightGray2 dark:border-darkGray  w-full max-w-[1440px]"
      ...
      <div className="w-full max-w-[1440px] flex flex-col items-center justify-center sm:flex-row sm:justify-between pb-[50px] sm:pb-0">
        ...
        <div className="w-full flex flex-col items-center sm:items-start justify-center sm:pl-16">
          ...
          <p className="text-[16px] text-#9B9B9B pt-[20px]">
            @2024 Attention OÜ
          </p>
        </div>
        <div className="hidden sm:block mr-[20px] sm:mr-[60px] border-x-[0.5px] border-lightGray2 dark:border-darkGray min-h-[128px] min-w-[60px]" />
