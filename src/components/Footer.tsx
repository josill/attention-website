...
export default function Footer() {
  return (
    <div className="flex flex-col justify-center items-center bg-bgWhite dark:bg-black text-textGray8 dark:text-lightGray3 text-[16px] sm:text-[20px] sm:px-8">
      <div
        className="flex flex-col sm:flex-row items-center justify-center sm:justify-between border-y border-lightGray2 dark:border-darkGray3 mt-[80px] w-full max-w-[1440px]"
      ...
      >
        ...
        <div className="hidden sm:block mr-[10px] border-x-[0.5px] border-lightGray2 dark:border-darkGray3 min-h-[128px] min-w-[60px]" />
      </div>
      <div className="w-full max-w-[1440px] flex flex-col items-center justify-center sm:flex-row sm:justify-between pb-[50px]">
        <div className="hidden sm:block ml-[10px] border-x-[0.5px] border-lightGray2 dark:border-darkGray3 min-h-[128px] min-w-[60px]" />
