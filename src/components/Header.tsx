...
function Header() {
  return (
    <nav className="flex justify-between items-center bg-bgWhite dark:bg-black px-2 py-4 font-spotnik w-[100vw]">
      ...
      <div className="flex flex-row">
        <ThemeSwitch />
        <img src="/header/burger-menu.svg" alt="buger-menu" className="pr-4" />
      </div>
    </nav>
  );
}
