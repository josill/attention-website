export const vertexShaderGLSL = `
    ...
    void main()
    {
        ...
        float noiseIntensity = 2.9;
        float mouseIntensity = 5.0; 
        ...
        float displacement = combinedNoise * noiseIntensity;
        vec3 adjustedPosition = position + normal * displacement + vec3(u_mousePosition.x * mouseIntensity, u_mousePosition.y * mouseIntensity, 0.0);
